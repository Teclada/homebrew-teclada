cask "teclada" do
    ...
    if Hardware::CPU.arm?
        ...
        url "https://github.com/Teclada/teclada/releases/download/0.0.29/teclada_mac_arm64.tar.gz"
    elsif Hardware::CPU.intel?
        url "https://github.com/Teclada/teclada/releases/download/0.0.29/teclada_mac_x86_64.tar.gz"
